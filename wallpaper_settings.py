...
All core settings functionality has been moved to the settings_modules package.
The main application entry point (wallpaper_generator.py) should now import
and use functions directly from the settings_modules package.
"""
...
# These re-exports can be removed after all code is updated to import from settings_modules
...
from settings_modules.menu_management.genres_menu import manage_genres
from settings_modules.menu_management.styles_menu import manage_styles
from settings_modules.menu_management.moods_menu import manage_moods
from settings_modules.menu_management.wallpaper_settings_menu import manage_wallpaper_settings
from settings_modules.menu_management.advanced_options_menu import configure_advanced_options, manage_imagen_settings, manage_prompt_generation_settings, reset_all_settings_to_none, manage_camera_settings, manage_output_quality_settings, manage_lighting_settings, manage_composition_settings, manage_color_settings, view_current_settings, reset_to_default, change_aspect_ratio, manage_negative_prompt
from settings_modules.ai_preset_generation import generate_ai_preset

# The global user_prefs variable is now managed within settings_modules.settings_manager
