...
# Updated application imports
from wall_gen.ui_utils import print_section, print_success, print_error, print_warning, print_info, get_validated_input, print_option
from .settings_manager import get_preferences # Relative import is correct here
