    ...
    while True:
        ...
        if choice == "1":
            ...
            type_choice = get_validated_input(
                "Select lighting type (1-6, b)", ["1", "2", "3", "4", "5", "6", "b"]
            )
            ...
            if type_choice == "6":
                ...
                user_prefs.imagen_settings["lighting_settings"]["lighting_type"] = (
                    lighting_types[type_choice]
                )
            ...
            time_choice = get_validated_input(
                "Select time of day (1-8, b)",
                ["1", "2", "3", "4", "5", "6", "7", "8", "b"],
            )
            ...
            if time_choice == "8":
                ...
                user_prefs.imagen_settings["lighting_settings"]["time_of_day"] = times[
                    time_choice
                ]
            ...
            source_choice = get_validated_input(
                "Select light source (1-6, b)", ["1", "2", "3", "4", "5", "6", "b"]
            )
            ...
            if source_choice == "6":
                ...
                user_prefs.imagen_settings["lighting_settings"]["light_source"] = (
            ...
            quality_choice = get_validated_input(
                "Select light quality (1-6, b)", ["1", "2", "3", "4", "5", "6", "b"]
            )
            ...
            if quality_choice == "6":
                ...
                user_prefs.imagen_settings["lighting_settings"]["light_quality"] = (
                    qualities[quality_choice]
                )
            ...
            while True:
                ...
                current_sources = user_prefs.imagen_settings["lighting_settings"].get(
                    "artificial_sources", []
                )
                if current_sources:
                ...
                if source_choice == "1":
                    ...
                    if current_sources:
                        confirm = get_validated_input(
                            "Are you sure you want to clear all sources? (y/n)",
                            ["y", "n"],
                        )
                        if confirm.lower() == "y":
                            user_prefs.imagen_settings["lighting_settings"][
